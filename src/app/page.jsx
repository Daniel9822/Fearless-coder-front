...
import {
  moreInfo,
  paragraphOne,
  paragraphOneContinue,
  paragraphTwo,
  paragraphTwoContinue,
  titleQuestion,
  titleTwo,
  welcomeText,
  welcomeTextTwo
} from '@/constants/constansHome'
  ...
  return (
    <>
      <main className={style.mainContent}>
        ...
        <div className={style.homeInfo}>
          <div className={style.content}>
            <p>
              {welcomeText}
              <strong className={style.textStrong}>{welcomeTextTwo}</strong>
            </p>
      ...
      <ContentCreate
        ...
        reverse={true}
        title={titleTwo}
        img={'/video-conference1.avif'}
        paragraph={[paragraphTwo, paragraphTwoContinue]}
      ></ContentCreate>
      <Footer />
    </>
  )
